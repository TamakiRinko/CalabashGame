...
public class CalabashTwo extends Calabash {

    public CalabashTwo(int blood, int px, int py, Color color, Rank rank, Image image) {
    ...
    public void run() {
        ...
        while (!isDead){
            ...
            sleep(ConstValues.CalabashTwoGenerateBulletInterval);
